...
namespace Komis.Models
{
    ...
    {
        public static void Seed(AppDbContext context)       //sprawdzenie czy baza sql posiada jakies dane jeśli nie to dodaje się dane do bazy
        {
            if (!context.Samochody.Any())
            {
                ...
                new Samochod { Marka = "Opel", Model = "Astra", RokProdukcji = 2010, Przebieg = "215000 km", Pojemnosc = "1 700 cm3", RodzajPaliwa = "dyzel", Moc = "150 KM", Opis = "Przedstawiam Państwu wyjątkowe auto jakim jest Łopel Astra J po czipe na 150 kuni. Opla Astra J, przez wielu uważany za najpiękniejsze auto w historii motoryzacji, przeze mnie też.", Cena = 1200000M, ZdjecieUrl = "/images/opel.jpg", MiniaturkaUrl = "/images/opel.jpg", JestSamochodemTygodnia = true });
            }

            context.SaveChanges();                          //tutaj zapisuję się zmiany
        }
    }
}
